...
"""
## Template
# i_completed_introduction_to_github = False
# i_completed_communicate_using_markdown = False
# i_completed_github_pages = False

# ## Solutions
i_completed_introduction_to_github = True
i_completed_communicate_using_markdown = True
i_completed_github_pages = True